...
(1, 35, 'Madrid', 28009, 'Sushi Running es nuestro restaurante japones donde podras organizar
 desde eventos de negocios, familiares, o con amigos. No dudes en contactar con nosotros y prepararemos el menu
  que necesitas para que todo tu evento sea un exito.', 'Calle de Alcala, 110', '40.42555362512207', '-3.673552613736124', 'Sushi Running in Osaka', 'Madrid', '614563321', 3	
);
...
(2, 40, 'Madrid', 28015, 'Rio Nalon, Restaurante Argentino en Madrid, representa el concepto de Parrilla Argentina con caracter contemporaneo.
 Personalidad inconfundible y maestria a las brasas, con un punto de equilibrio, que siempre sorprende.',
  'Calle de Donoso Cortes, 8', '40.43616155031258', '-3.7054870463800778', 'Meson Restaurante Rio Nalon', 'Madrid', '656789675', 3	
);

INSERT INTO NEGOCIO(id, aforo_maximo, ciudad, codigo_postal, descripcion, direccion, latitud, longitud, nombre, provincia, telefono, propietario_id) VALUES 
(3, 15, 'Madrid', 28001, 'Tienda de accesorios de moda en Madrid',
  'Calle del Conde de Aranda, 22, bajo derecha', '40.40217667668157', '-3.8884685988487973', 'ES Fascinante', 'Madrid', '913369742', 2	
);

INSERT INTO NEGOCIO(id, aforo_maximo, ciudad, codigo_postal, descripcion, direccion, latitud, longitud, nombre, provincia, telefono, propietario_id) VALUES 
(4, 40, 'Madrid', 28015, 'Los Montes gallegos, Gran seleccion, Sofisticado espacio de ambiente actual e intimo que sirve especialidades gallegas, ademas de cocteles y copas.',
  'Calle de Azcona, 46', '40.43616155032637', '-3.7054870463806857', 'Los Montes gallegos', 'Madrid', '698547589', 2	
);
...
El mejor sabor con influencias de las culturas española, francesa, italiana, britanica, alemana, africana y nativa americana.',
  'Av. de la Albufera, 20', '40.39752183009516', '-3.6678742825609643', 'Popeyes Louisiana Kitchen', 'Madrid', '699342331', 1
);

INSERT INTO NEGOCIO(id, aforo_maximo, ciudad, codigo_postal, descripcion, direccion, latitud, longitud, nombre, provincia, telefono, propietario_id) VALUES 
(6, 10, 'Madrid', 28041, 'Disfruta de lo mejor de la cocina turca de todo Madrid pidiendo a domicilio al restaurante kebabish. 
Disfruta de lo mejor de la cocina turca al mejor precio.', 'Carretera de Villaverde a Vallecas, 29', '40.35803319519468', '-3.685741134378008440', 'Kebabish Villaverde', 'Madrid', '917729384', 3
);
...
INSERT INTO RESERVA(id, capacidad, estado, fin, inicio, num_personas, negocio_id, usuario_id) VALUES (
	1, 2, 0, '2021-05-16 13:29:00','2021-05-16 12:59:00', 0, 1, null    
);
INSERT INTO RESERVA(id, capacidad, estado, fin, inicio, num_personas, negocio_id, usuario_id) VALUES (
	2, 2, 0, '2021-05-16 13:29:00','2021-05-16 12:59:00', 0, 1, null    
);
INSERT INTO RESERVA(id, capacidad, estado, fin, inicio, num_personas, negocio_id, usuario_id) VALUES (
	3, 2, 0, '2021-05-16 13:59:00','2021-05-16 13:29:00', 0, 1, null    
);
INSERT INTO RESERVA(id, capacidad, estado, fin, inicio, num_personas, negocio_id, usuario_id) VALUES (
	4, 2, 0, '2021-05-16 13:59:00','2021-05-16 13:29:00', 0, 1, null    
);
